...
if nargin < 2
    ...
    uilist =    {...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Remove bad channels' 'fontweight' 'bold' 'tag' 'chanrm' 'callback' cb_chan 'value' 0 } ...
        {} {'style' 'checkbox' 'string' 'Remove channel if it is flat for more than (seconds)' 'tag' 'rmflat' 'userdata' 'chan' 'value' 0 } ...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Max acceptable high-frequency noise std dev' 'value' 0 'tag' 'rmnoise' 'userdata' 'chan' } ...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Min acceptable correlation with nearby chans [0-1]' 'value' 0 'tag' 'rmcorr' 'userdata' 'chan'   } ...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Additional removal of bad data periods' 'fontweight' 'bold' 'value' 0 'tag' 'rejwin' 'callback' cb_rej } ...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Pop up scrolling data window with rejected data highlighted' 'tag' 'vis' 'value' fastif(length(EEG) > 1, 0, 0) 'enable' fastif(length(EEG) > 1, 'off', 'on') }};
