...
g = arg_define([0 1], varargin, ...
    ...
    arg({'winsize','SlidingWinLength'},fastif(EEG.trials==1,5,EEG.pnts/EEG.srate),[0 EEG.pnts/EEG.srate],'Sliding window length (sec). Default for epoched data is the epoch length. Default for continuous data is 4 seconds'), ...
